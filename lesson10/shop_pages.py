...
class LoginPage:
    ...
    @allure.step("Выполнить вход в систему под пользователем: {user}")
...
class MainPage:
    ...
    @allure.step("Добавить три выбранных товара в корзину")
...
class CheckoutPage:
    ...
    @allure.step("Заполнить форму личными данными: {first} {last}")
